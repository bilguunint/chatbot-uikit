...
export default function Sidebar({
  ...
  if (collapsed) {
    return (
      <aside className="w-[56px] min-w-[56px] h-screen flex flex-col items-center bg-sidebar border-r border-border-light transition-all duration-200">
        {/* Logo + expand */}
  ...
  return (
    <aside className="w-[240px] min-w-[240px] h-screen flex flex-col bg-sidebar border-r border-border-light transition-all duration-200">
      {/* Logo */}
