...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  // Apply CSS variables for primary color + sidebar overrides
  useEffect(() => {
    const c = primaryColors[primaryKey] ?? primaryColors.purple;
    const root = document.documentElement;

    // Primary color shades — always override
    ...
    // Sidebar/border colors — set in light, remove in dark so .dark CSS wins
